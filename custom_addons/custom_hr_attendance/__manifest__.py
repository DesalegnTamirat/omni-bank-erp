# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/my_shift_schedule_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'custom_hr_attendance/static/src/dashboard/attendance_dashboard.js',
            'custom_hr_attendance/static/src/dashboard/attendance_dashboard.xml',
            'custom_hr_attendance/static/src/dashboard/attendance_dashboard.scss',
